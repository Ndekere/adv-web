            ...
            <div class="page-title-area">
                ...
                <div class="main-content-inner">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="header-title">A simple TO-DO List.</div>
                                <div style="text-align:center;">
                                <ol style="font-size: 25px;" >
                                    <li>
                                    <p>
                                         <del>Do Mr.Raphael's Project.</del>    --> Done. 
                                        </p>
                                    </li>
                                    <li>
                                    <p>
                                         <del>Enjoy my Weekend.</del>    --> Done. 
                                        </p>
                                    </li>
                                    <li>
                                    <p>
                                         <del>Create a database 4 this project.</del>    --> Done. 
                                        </p>
                                    </li>
                                    <li>Attend today's classes.</li>
